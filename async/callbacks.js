...
// const obj = {};
// const checkedDays = ['monday', 'tuesday'];
// const mas = ['monday', 'tuesday', 'wednesday'];
// mas.map(elm => {
//     obj[elm] = checkedDays.indexOf(elm) !== -1
// })
// // if (mas.includes(elm => reminder[elm])) {
// //
// // }
//
// console.log(mas.some(elm => obj[elm]));

// const Far = new Number('fghghj');
// console.log(Far);
// console.log(typeof Far === 'number');

// const mas = ['ss', 'ttt', 'ttt5', 'qq'];
// console.log(mas[1]);
// console.log(mas[-1]);
// console.log(mas[-2]);

const str =
    {"name":"Название анкеты","description":"Это очень важный анамнез","commentary":"Беременные бывают нервными","questions_json":"{\n \"title\": \"Название анкеты\",\n \"description\": \"Это очень важный анамнез\",\n \"logoPosition\": \"right\",\n \"pages\": [\n  {\n   \"name\": \"page1\",\n   \"elements\": [\n    {\n     \"type\": \"text\",\n     \"name\": \"question1\",\n     \"title\": \"Сколько овощей Вы едите в день?\",\n     \"isRequired\": true,\n     \"inputType\": \"number\",\n     \"step\": 1\n    }\n   ]\n  },\n  {\n   \"name\": \"page2\",\n   \"elements\": [\n    {\n     \"type\": \"checkbox\",\n     \"name\": \"question2\",\n     \"title\": \"Выбери какие типы таблеток ты пьешь?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"БАДы\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"гормоны\"\n      },\n      {\n       \"value\": \"item3\",\n       \"text\": \"противовирусные\"\n      },\n      {\n       \"value\": \"item4\",\n       \"text\": \"для ЖКТ\"\n      }\n     ],\n     \"hasNone\": true,\n     \"noneText\": \"Ничего не пью\",\n     \"hasSelectAll\": true,\n     \"selectAllText\": \"Выбрать все\"\n    }\n   ],\n   \"visibleIf\": \"{question1} > 5\"\n  },\n  {\n   \"name\": \"page3\",\n   \"elements\": [\n    {\n     \"type\": \"dropdown\",\n     \"name\": \"question3\",\n     \"title\": \"Какую одежду Вы предпочитаете носить?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Свободного кроя (абсолютно не сковывающую)\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Полу-приталенный крой\"\n      },\n      {\n       \"value\": \"item3\",\n       \"text\": \"В обтяжку\"\n      },\n      {\n       \"value\": \"item4\",\n       \"text\": \"Очень тугую (в том числе корсеты)\"\n      }\n     ],\n     \"placeholder\": \"Выберите...\",\n     \"allowClear\": false\n    }\n   ]\n  },\n  {\n   \"name\": \"page4\",\n   \"elements\": [\n    {\n     \"type\": \"radiogroup\",\n     \"name\": \"question4\",\n     \"title\": \"У вас была повышенная температура ближайшие пару недель?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Да\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Нет\"\n      }\n     ]\n    }\n   ]\n  },\n  {\n   \"name\": \"page5\",\n   \"elements\": [\n    {\n     \"type\": \"text\",\n     \"name\": \"question5\",\n     \"visibleIf\": \"{question4} = 'item1'\",\n     \"title\": \"Сколько дней держалась повышенная температура?\",\n     \"isRequired\": true,\n     \"inputType\": \"number\"\n    }\n   ]\n  },\n  {\n   \"name\": \"page6\",\n   \"elements\": [\n    {\n     \"type\": \"text\",\n     \"name\": \"question6\",\n     \"visibleIf\": \"{question4} = 'item1'\",\n     \"title\": \"Самое высокое значение температуры в ближайшие три недели?\",\n     \"isRequired\": true,\n     \"inputType\": \"number\",\n     \"min\": 36.6,\n     \"step\": 0.1\n    }\n   ]\n  },\n  {\n   \"name\": \"page7\",\n   \"elements\": [\n    {\n     \"type\": \"radiogroup\",\n     \"name\": \"question7\",\n     \"title\": \"Была ли у Вас сыпь в ближайшие 3 недели?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Да\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Нет\"\n      }\n     ]\n    }\n   ]\n  },\n  {\n   \"name\": \"page8\",\n   \"elements\": [\n    {\n     \"type\": \"radiogroup\",\n     \"name\": \"question8\",\n     \"title\": \"Был ли озноб ближайшие три недели?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Да\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Нет\"\n      }\n     ]\n    }\n   ]\n  },\n  {\n   \"name\": \"page9\",\n   \"elements\": [\n    {\n     \"type\": \"radiogroup\",\n     \"name\": \"question9\",\n     \"visibleIf\": \"{question7} = 'item1' and {question8} = 'item1'\",\n     \"title\": \"Была ли у Вас рвота ближайшие три недели?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Да\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Нет\"\n      }\n     ]\n    }\n   ]\n  },\n  {\n   \"name\": \"page10\",\n   \"elements\": [\n    {\n     \"type\": \"radiogroup\",\n     \"name\": \"question10\",\n     \"visibleIf\": \"{question7} = 'item1' and {question8} = 'item2'\",\n     \"title\": \"Была ли у Вас диарея ближайшие 3 недели?\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Да\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Нет\"\n      }\n     ]\n    }\n   ]\n  },\n  {\n   \"name\": \"page11\",\n   \"elements\": [\n    {\n     \"type\": \"dropdown\",\n     \"name\": \"question11\",\n     \"visibleIf\": \"{question9} = 'item1'\",\n     \"title\": \"Опишите характер рвоты\",\n     \"isRequired\": true,\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Рвало едой\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"рвало жидкостью\"\n      },\n      {\n       \"value\": \"item3\",\n       \"text\": \"рвало желчью\"\n      },\n      {\n       \"value\": \"item4\",\n       \"text\": \"непонятно\"\n      }\n     ]\n    }\n   ]\n  },\n  {\n   \"name\": \"page12\",\n   \"elements\": [\n    {\n     \"type\": \"comment\",\n     \"name\": \"question12\",\n     \"title\": \"Опишите сюжеты Ваших снов\",\n     \"isRequired\": true\n    }\n   ]\n  },\n  {\n   \"name\": \"page13\",\n   \"elements\": [\n    {\n     \"type\": \"radiogroup\",\n     \"name\": \"question13\",\n     \"title\": \"Проживает ли с Вами пушистое животное?\",\n     \"choices\": [\n      {\n       \"value\": \"item1\",\n       \"text\": \"Да\"\n      },\n      {\n       \"value\": \"item2\",\n       \"text\": \"Нет\"\n      }\n     ]\n    }\n   ],\n   \"visibleIf\": \"{question12} contains 'Слон удивительный'\"\n  },\n  {\n   \"name\": \"page14\",\n   \"elements\": [\n    {\n     \"type\": \"text\",\n     \"name\": \"question14\",\n     \"title\": \"Надо что-нибудь придумат\",\n     \"isRequired\": true,\n     \"inputType\": \"range\"\n    }\n   ]\n  },\n  {\n   \"name\": \"page15\",\n   \"elements\": [\n    {\n     \"type\": \"text\",\n     \"name\": \"question15\",\n     \"title\": \"Дата рождения\",\n     \"isRequired\": true,\n     \"inputType\": \"date\"\n    }\n   ]\n  },\n  {\n   \"name\": \"page16\",\n   \"elements\": [\n    {\n     \"type\": \"text\",\n     \"name\": \"question16\",\n     \"title\": \"Выберите неделю на которой был первый день менструации\",\n     \"isRequired\": true,\n     \"inputType\": \"week\"\n    }\n   ]\n  }\n ],\n \"showProgressBar\": \"top\",\n \"pagePrevText\": \"Назад\",\n \"pageNextText\": \"Продолжить\",\n \"completeText\": \"Завершить\",\n \"comment\": \"Беременные бывают нервными\"\n}","question_count":9};

console.dir({...JSON.parse(str.questions_json)});