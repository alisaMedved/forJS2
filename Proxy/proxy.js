...
// Прокси - Proxy - это паттерн ООП программирования - это обертка над целевым объектом, которая
// перехватывает и переопределяет основные операции для этого объекта. В js существует специальный втроенный конструктор для создания proxy,
// также следует отметить что в js прокси может оборачивать объекты, классы, функции, массивы и т.д.
